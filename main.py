...
root = Tk()
root.iconbitmap('c:/Users/Labay/Desktop/discvlogo.ico')
root.title("NMT-Processor Simulator")

#########################################################################################
my_tabs = ttk.Notebook(root)
tab1 = ttk.Frame(my_tabs)

my_tabs.add(tab1, text ='code and memory-thread status') # adding tab
...
'endmodule \n'
    ...
    os.system("iverilog -o mac2 tmpfile.sv");
    os.system("vvp mac2 > resultfile2");
